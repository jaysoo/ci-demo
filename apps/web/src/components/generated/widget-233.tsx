...
const SEED: Record233[] = Array.from({ length: 24 }, (_, i) => ({
  id: `r-233-${i}`,
  owner: `owner-${i % 5}`,
    ...
    <Card variant="outlined">
      <CardContent>
        <Stack direction="row" spacing={1} sx={{ alignItems: 'center', mb: 1 }}>
          ...
          <Typography variant="h6">Board 233</Typography>
      ...
      <Dialog open={dialog} onClose={() => setDialog(false)}>
        <DialogTitle>Board 233</DialogTitle>
        <DialogContent>
